...
1.  Make anonymization the default for uploads:
...
18.  Use deep linking to add option to upload from phone's gallery to the permaweb

19.  Option to share pictures from the app using other installed mobile apps (e.g. WhatsApp, Telegram, etc)
